...
starvation_image = pygame.image.load("Starvation.png")
crosshair_image = pygame.image.load("crosshair.png")
westville_image = pygame.image.load("westville.png")
...
starvation_rect = starvation_image.get_rect(center=(screen_width // 2, screen_height // 2))
crosshair_rect = crosshair_image.get_rect()
westville_rect = westville_image.get_rect()


custom_font_path = "Intruder.ttf"
font_size = 20
...
westville_state = "westville_state"
...
while running:
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            if current_state == title_screen:
                ...
                if event.key == pygame.K_RETURN:
                    current_state = starvation_state
            elif current_state == starvation_state and event.key == pygame.K_RETURN:
                current_state = westville_state
    ...
    if current_state == title_screen:
        ...
        dialog_y = 200
        outline_color = (255, 0, 0)  #redoutlone
        ...
        pos_line1 = (screen_width // 2, screen_height // 4)
        ...
        if buffalo_clicked and show_continue_text:
            user_choice = None
            show_continue_text = False
            follow_up_text = None  # Resettxt

    elif current_state == starvation_state:
        screen.blit(starvation_image, starvation_rect)
        text_starvation_line1 = "As you pass through Tennessee and Missouri, your water supply diminishes."
        text_starvation_line2 = "It will be a few days before you get a drink."
        pos_starvation_line1 = (screen_width // 2, screen_height // 3)
        pos_starvation_line2 = (screen_width // 2, screen_height * 2 // 5)
        render_text_with_outline(text_starvation_line1, pos_starvation_line1, (255, 255, 255), (0, 0, 0))
        render_text_with_outline(text_starvation_line2, pos_starvation_line2, (255, 255, 255), (0, 0, 0))
        text_press_enter = "Press Enter wto Continue"
        pos_press_enter = (screen_width // 2, screen_height - 30)
        render_text_with_outline(text_press_enter, pos_press_enter, (255, 255, 255), (0, 0, 0))
    elif current_state == westville_state:
        screen.blit(westville_image, westville_rect)
        text_westville_line1 = "Congratulations, you made it to Westville, Oklahoma!"
        text_westville_line2 = "Westville was a popular ending point of the Trail of Tears."
        text_westville_line3 = "Many people, including Washington Lee, were forced to start their lives over."
        text_westville_line4 = "Washington Lee lost his Mother, Father, and Sister during The Trail of Tears;"
        text_westville_line5 = "he never knew what happened to them."
        text_westville_line6 = "The End."
        pos_westville_line1 = (screen_width // 2, screen_height //4)
        pos_westville_line2 = (screen_width // 2, screen_height  //3)
        pos_westville_line3 = (screen_width // 2, screen_height //2.5)
        pos_westville_line4 = (screen_width // 2, screen_height // 2)
        pos_westville_line5 = (screen_width // 2, screen_height //1.75 )
        pos_westville_line6 = (screen_width // 2, screen_height - 10)

        render_text_with_outline(text_westville_line1, pos_westville_line1, (255, 255, 255), (0, 0, 0))
        render_text_with_outline(text_westville_line2, pos_westville_line2, (255, 255, 255), (0, 0, 0))
        render_text_with_outline(text_westville_line3, pos_westville_line3, (255, 255, 255), (0, 0, 0))
        render_text_with_outline(text_westville_line4, pos_westville_line4, (255, 255, 255), (0, 0, 0))
        render_text_with_outline(text_westville_line5, pos_westville_line5, (255, 255, 255), (0, 0, 0))
        render_text_with_outline(text_westville_line6, pos_westville_line6, (255, 255, 255), (0, 0, 0))
    pygame.display.flip()
    clock.tick(60)
